...
then
	...
	export ALLOW_MISSING_DEPENDENCIES=true
        echo -e "\x1b[96municorn: 开始添加OrangeFox Vars...\x1b[m"
	## 构建信息
	# 设置显示在关于页面里的维护人员名称
	export OF_MAINTAINER=Minus
	# 设置版本号为日期
	...
	F=$(find "device" -maxdepth 2 -name "unicorn")
	# 修改启动画面背景色为#000000
	...
	echo -e "\x1b[96municorn: 当你看到这个消息的时候，所有的OrangeFox Var已经添加完毕！\x1b[m"
